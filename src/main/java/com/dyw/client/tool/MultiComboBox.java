...
public class MultiComboBox extends JComponent {
    ...
    public List<NameCode> defaultValues;
...
//		this(value,defaultValue,DEFAULT_VALUE_SPERATOR);
    ...
    public void initParameter(List<NameCode> value, List<NameCode> defaultValue) {
        values = value;
    ...
    public void MultiComboBox_repaint(List<NameCode> value, List<NameCode> defaultValue) {
        this.repaint();
        values = value;
        defaultValues = defaultValue;
	...
	/*public MultiComboBox(List<NameCode> value, List<NameCode> defaultValue , String valueSperator) {
		values = value;
		defaultValues = defaultValue;
