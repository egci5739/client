...
public class JDialogPlayBackByTime extends javax.swing.JDialog {
     ...
     *************************************************/
    public JDialogPlayBackByTime(java.awt.Frame parent, boolean modal, NativeLong lUserID) {
        super(parent, modal);
        initComponents();
        initialDialog();
        m_lUserID = lUserID;
    ...
    public static void main(String[] args) {
        JDialogPlayBackByTime jDialogPlayBackByTime = new JDialogPlayBackByTime(null, true, new NativeLong(1));
        jDialogPlayBackByTime.initialDialog();
    }
}
